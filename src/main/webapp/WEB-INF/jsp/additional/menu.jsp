    ...
    <header>
        <div class="container">
            <div class="clearfix" id="heading">
                ...
                <a class="lang-btn" href="/change-lang?lang=ru">
                    <img class="lang-icone" src="img/lang/rus.png">
                </a>
                <a class="lang-btn" href="/change-lang?lang=en">
                    <img class="lang-icone" src="img/lang/eng.png">
                </a>
            </div>
            <nav>
                <ul class="menu">
